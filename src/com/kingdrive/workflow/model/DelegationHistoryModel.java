...
public class DelegationHistoryModel implements java.io.Serializable {
  private Integer delegationHistoryId = null;

  private boolean delegationHistoryIdModifyFlag;
  ...
  public void clearModifyFlag() {
    this.delegationHistoryIdModifyFlag = false;
  ...
  public void setDelegationHistoryId(int delegationHistoryId) {
    this.delegationHistoryId = new Integer(delegationHistoryId);
    this.delegationHistoryIdModifyFlag = true;
  }

  public void setDelegationHistoryId(Integer delegationHistoryId) {
    this.delegationHistoryId = delegationHistoryId;
    this.delegationHistoryIdModifyFlag = true;
  }

  public Integer getDelegationHistoryId() {
  ...
  public boolean getDelegationHistoryIdModifyFlag() {
    return this.delegationHistoryIdModifyFlag;
  }
